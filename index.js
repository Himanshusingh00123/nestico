...
const signup=()=>{
    swal.fire({
        html:`
            ...
            <label class="text-gray-700 font-semibold text-sm lg:text-xl ">I agree to the <a href="#" class="text-blue-600 hover:text-orange-600">Terms of Service</a> and <a href="#" class="text-blue-600 hover:text-orange-600">Privacy Policy</a> </label>
            </div>
  ...
  const address=()=>{
    swal.fire({
        html:`<div class=" flex flex-col justify-center items-center  md:pt-1  bg-white px-4 py-2 lg:rounded-2xl rounded-xl    ">
            ...
            <form class="flex flex-col lg:m-4 m-3 lg:gap-3  gap-2" onsubmit="add_address()">
            <input id="name" type="text" placeholder="*Full name" class="border lg:p-3 p-2 rounded-xl  text-black  focus:ring-3 focus:ring-blue-600 border-3 border-gray-600 " required>
            ...
            <button class=" bg-blue-600 hover:bg-orange-600 lg:p-3 p-2 text-white font-bold lg:rounded-xl  rounded-lg lg:text-lg text-md mt-3 mb-1 md:mt-1 md:mb-0 hover:scale-105 duration-300 ease-in-out" >Add Address</button>  
            </form>
            </div>
        </div>
    </div>`,
   ...
   const profile=()=>{
    swal.fire({
        html:`<div class=" flex flex-col justify-center items-center  md:pt-1  bg-white px-4 py-2 lg:rounded-2xl rounded-xl    ">
            <img src="https://cdn-icons-png.flaticon.com/512/3135/3135768.png" alt="signup img" class="lg:w-20 w-15 sm:pt-10 lg:p-2 animate__animated animate__slideInDown">
            <h1 class="lg:text-5xl text-3xl font-bold text-black pt-1 md:pb-1">Profile</h1>
            <form class="flex flex-col lg:m-4 m-3 lg:gap-3  gap-2" onsubmit="savechanges()">
            <input id="name" type="text" placeholder="Full name" class="border lg:p-3 p-2 rounded-xl  text-black  focus:ring-3 focus:ring-blue-600 border-3 border-gray-600 " required>
            <input id="mobile" type="tel" placeholder="+91 Mobile Number" class="border lg:p-3 p-2 rounded-xl  text-black  focus:ring-3 focus:ring-blue-600 border-3 border-gray-600 " required>
            <div class="flex justify-center items-center gap-1 lg:justify-start">
            <lable for="dob" class="lg:hidden text-xl font-bold text-black">DOB: </lable>
            <input id="Dob" type="date"  class="border lg:px-10 lg:py-3 py-2 rounded-xl  text-black  focus:ring-3 focus:ring-blue-600 border-3 border-gray-600 " required>
            </div>
            <input id="city" type="text" placeholder="*Enter Your City" class="border lg:p-3 p-2 rounded-xl  text-black focus:ring-3 focus:ring-blue-600 border-3 border-gray-600" required>
            <input id="state" type="text" placeholder="*State/Province/Region " class="border lg:p-3 p-2 rounded-xl  text-black focus:ring-3 focus:ring-blue-600 border-3 border-gray-600 " required> 
            <input id="pincode" type="text" placeholder="*Zip/Pincode" class="border lg:p-3 p-2 rounded-xl  text-black  focus:ring-3 focus:ring-blue-600 border-3 border-gray-600 " required>
            <button class=" bg-blue-600 hover:bg-orange-600 lg:p-3 p-2 text-white font-bold lg:rounded-xl  rounded-lg lg:text-lg text-md mt-3 mb-1 md:mt-1 md:mb-0 hover:scale-105 duration-300 ease-in-out" >Save Changes</button>  
            </form>
            </div>
        </div>
    </div>`,
...
const booking=()=>{
    ...
    swal.fire({
        icon:"success",
        title:"Your Service Add Successfully"
    });
...
const showbooking=()=>{
    swal.fire({
        html:`<div class="text-center"><h1 class="text-black font-bold lg:text-4xl  text-2xl">Your Booking is : <span class="text-red-500">${count}</span></h1></div>
        <button class="bg-blue-500 hover:bg-orange-500  lg:p-3 p-2 lg:rounded-xl rounded-lg text-white lg:text-xl text-lg font-bold mt-4" onclick="emptycart()">Empty Cart</button>`,
